-- CreateEnum
CREATE TYPE "RoleType" AS ENUM ('ADMIN', 'AGENT', 'COMPANY_ADMIN', 'COMPANY_USER', 'DEVELOPER', 'ADMINISTRATOR', 'MANAGER', 'STAFF', 'CLIENT', 'BRANCH_ADMIN');
...
-- CreateEnum
CREATE TYPE "SellType" AS ENUM ('SALE', 'REFUND', 'PROFORMA');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'CASH_ON_DELIVERY', 'MOBILE_MONEY', 'AIRTEL_MONEY', 'BANK_TRANSFER', 'MTN_MOBILE_MONEY', 'CASH', 'MOMO', 'CHEQUE', 'BANK_CHECK', 'MOBILE_PAYMENT');
...
CREATE TABLE "Items" (
    ...
    "taxCodeChangeCount" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Sell" (
    ...
    "rcptSign" TEXT,
    "totRcptNo" INTEGER,
    "vsdcRcptPbctDate" TEXT,
    "sdcId" TEXT,
    "mrcNo" TEXT,
    "invcNo" INTEGER,
    "type" "SellType" NOT NULL DEFAULT 'SALE',
    "parentSellId" TEXT,
    "refundReasonCode" TEXT,
    "refundReasonNote" TEXT,
    "isTrainingMode" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "CompanyTools" (
    ...
    "ebmDeviceSerialNumber" TEXT,
    "invoiceDeclarationDate" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "EbmPurchaseDraft" (
    ...
    CONSTRAINT "EbmPurchaseDraft_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "EbmImportDraft" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "lastReqDt" TEXT NOT NULL,
    "isVat" BOOLEAN NOT NULL DEFAULT false,
    ...
    CONSTRAINT "EbmImportDraft_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "EbmSyncCursor" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "type" TEXT NOT NULL,
    "lastSyncedAt" TEXT NOT NULL,
    "batchDates" JSONB NOT NULL DEFAULT '[]',
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "EbmSyncCursor_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "XReportSession" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "branchId" TEXT,
    ...
    CONSTRAINT "XReportSession_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ZReportSession" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "branchId" TEXT,
    "startedAt" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "ZReportSession_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "DailyOpeningDeposit" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "branchId" TEXT,
    ...
    CONSTRAINT "DailyOpeningDeposit_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "User_mrcNo_key" ON "User"("mrcNo");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductCodeSequence_companyId_key" ON "ProductCodeSequence"("companyId");
...
-- CreateIndex
CREATE INDEX "EbmPurchaseDraft_companyId_isVat_idx" ON "EbmPurchaseDraft"("companyId", "isVat");

-- CreateIndex
CREATE INDEX "EbmPurchaseDraft_companyId_lastReqDt_idx" ON "EbmPurchaseDraft"("companyId", "lastReqDt");

-- CreateIndex
CREATE INDEX "EbmImportDraft_companyId_isVat_idx" ON "EbmImportDraft"("companyId", "isVat");

-- CreateIndex
CREATE INDEX "EbmImportDraft_companyId_lastReqDt_idx" ON "EbmImportDraft"("companyId", "lastReqDt");

-- CreateIndex
CREATE INDEX "EbmSyncCursor_companyId_idx" ON "EbmSyncCursor"("companyId");

-- CreateIndex
CREATE UNIQUE INDEX "EbmSyncCursor_companyId_type_key" ON "EbmSyncCursor"("companyId", "type");

-- CreateIndex
CREATE INDEX "XReportSession_companyId_startedAt_idx" ON "XReportSession"("companyId", "startedAt");

-- CreateIndex
CREATE INDEX "ZReportSession_companyId_endedAt_idx" ON "ZReportSession"("companyId", "endedAt");

-- CreateIndex
CREATE INDEX "DailyOpeningDeposit_companyId_date_idx" ON "DailyOpeningDeposit"("companyId", "date");
...
-- AddForeignKey
ALTER TABLE "Approvals" ADD CONSTRAINT "Approvals_stockReceiptId_fkey" FOREIGN KEY ("stockReceiptId") REFERENCES "StockReceipts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EbmPurchaseDraft" ADD CONSTRAINT "EbmPurchaseDraft_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EbmImportDraft" ADD CONSTRAINT "EbmImportDraft_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EbmSyncCursor" ADD CONSTRAINT "EbmSyncCursor_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "XReportSession" ADD CONSTRAINT "XReportSession_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ZReportSession" ADD CONSTRAINT "ZReportSession_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DailyOpeningDeposit" ADD CONSTRAINT "DailyOpeningDeposit_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
